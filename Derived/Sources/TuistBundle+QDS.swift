...
/// Since QDS is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "QDS_QDS"
    ...
    fatalError("unable to find bundle named QDS_QDS")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class QDSResources: NSObject {
